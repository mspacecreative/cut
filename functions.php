...
if ( function_exists( 'add_theme_support' ) ) {
    ...
    add_image_size( 'large-square', 600, 600, true ); // Custom Thumbnail Size call using the_post_thumbnail('custom-
    add_image_size( 'medium-square', 450, 450, true ); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
    ...
    load_theme_textdomain( 'torrent', get_template_directory() . '/languages' );
}
...
function register_html5_menu() {
    register_nav_menus( array( // Using array to specify more menus if needed
        'header-menu'  => esc_html( 'Header Menu', 'torrent' ), // Main Navigation
        'extra-menu'   => esc_html( 'Extra Menu', 'torrent' ) // Extra Navigation if needed (duplicate as many as you need!)
    ) );
}
...
function blogExcerpt() {
	...
	$excerpt = wp_trim_words('<p>' . $content, 20 . '</p>', '&hellip; <p><a class="view-article" href="' . get_permalink($post->ID) . '">' . __('Read article', 'volta') . '</a></p>');
	echo $excerpt;
}
...
include 'functions/modal-staff.php';
